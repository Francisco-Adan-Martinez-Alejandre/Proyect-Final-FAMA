...
class MxServicesPolitics extends ChangeNotifier {
  ...
  getService() async {
    final url = Uri.https(
      _urlBase,
      '/api/1/news',
      {'category': 'politics', 'country': 'mx', 'language': 'es'},
    );
    ...
    propertyMxPolitics = noticia.results!;
