...
class CoServicesPolitics extends ChangeNotifier {
  ...
  getService() async {
    final url = Uri.https(
      _urlBase,
      '/api/1/news',
      {'category': 'politics', 'country': 'co', 'language': 'es'},
    );
    ...
    propertyCoPolitics = noticia.results!;
