...
class PoliticsDAr extends StatelessWidget {
  const PoliticsDAr({Key? key}) : super(key: key);
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        arDataPolitics
                                            .propertyArPolitics[4].description,
