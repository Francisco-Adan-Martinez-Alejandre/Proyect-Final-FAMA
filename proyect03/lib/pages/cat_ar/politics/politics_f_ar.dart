...
class PoliticsFAr extends StatelessWidget {
  const PoliticsFAr({Key? key}) : super(key: key);
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        arDataPolitics
                                            .propertyArPolitics[6].description,
