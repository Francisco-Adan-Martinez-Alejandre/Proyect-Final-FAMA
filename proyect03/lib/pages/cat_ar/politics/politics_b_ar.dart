...
class PoliticsBAr extends StatelessWidget {
  const PoliticsBAr({Key? key}) : super(key: key);
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        arDataPolitics
                                            .propertyArPolitics[2].description,
