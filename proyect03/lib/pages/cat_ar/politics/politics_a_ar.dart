...
class PoliticsAAr extends StatelessWidget {
  const PoliticsAAr({Key? key}) : super(key: key);
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        arDataPolitics
                                            .propertyArPolitics[1].description,
