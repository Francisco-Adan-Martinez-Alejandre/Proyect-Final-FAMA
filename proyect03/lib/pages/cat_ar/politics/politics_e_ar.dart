...
class PoliticsEAr extends StatelessWidget {
  const PoliticsEAr({Key? key}) : super(key: key);
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        arDataPolitics
                                            .propertyArPolitics[5].description,
