...
class TopEAr extends StatelessWidget {
  const TopEAr({Key? key}) : super(key: key);
                                ...
                                Column(
                                  children: [
                                    SizedBox(
                                      ...
                                      child: Text(
                                        "Autor: " +
                                            arDataTop.propertyArTop[5].creator,
                              ...
                              child: ListView(
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        arDataTop.propertyArTop[5].description,
                              ...
                              child: ListView(
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        arDataTop.propertyArTop[5].content,
                                        textAlign: TextAlign.justify,
                                        style: const TextStyle(
                                            color: Color.fromARGB(235, 0, 0, 0),
                                            fontSize: 15,
