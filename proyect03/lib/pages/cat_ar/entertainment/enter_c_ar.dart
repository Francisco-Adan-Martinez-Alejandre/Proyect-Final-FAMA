...
class EnterCAr extends StatelessWidget {
  const EnterCAr({Key? key}) : super(key: key);
                              ...
                              child: ListView(
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        arDataEnter.propertyArEnter[3].content,
                                        textAlign: TextAlign.justify,
                                        style: const TextStyle(
                                            color: Color.fromARGB(235, 0, 0, 0),
                                            fontSize: 15,
