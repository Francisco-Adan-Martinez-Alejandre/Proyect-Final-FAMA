...
class SportsEAr extends StatelessWidget {
  const SportsEAr({Key? key}) : super(key: key);
                              ...
                              child: ListView(
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        arDataSports.propertyArSports[5].title,
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        arDataSports
                                            .propertyArSports[5].description,
