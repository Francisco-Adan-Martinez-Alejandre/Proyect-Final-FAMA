...
class SportsAAr extends StatelessWidget {
  const SportsAAr({Key? key}) : super(key: key);
                              ...
                              child: ListView(
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        arDataSports.propertyArSports[1].title,
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        arDataSports
                                            .propertyArSports[1].description,
