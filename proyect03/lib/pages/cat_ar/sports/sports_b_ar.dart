...
class SportsBAr extends StatelessWidget {
  const SportsBAr({Key? key}) : super(key: key);
                              ...
                              child: ListView(
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        arDataSports.propertyArSports[2].title,
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        arDataSports
                                            .propertyArSports[2].description,
