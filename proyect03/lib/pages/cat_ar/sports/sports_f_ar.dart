...
class SportsFAr extends StatelessWidget {
  const SportsFAr({Key? key}) : super(key: key);
                              ...
                              child: ListView(
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        arDataSports.propertyArSports[6].title,
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        arDataSports
                                            .propertyArSports[6].description,
