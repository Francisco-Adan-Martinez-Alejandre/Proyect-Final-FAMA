...
class PoliticsCUs extends StatelessWidget {
  const PoliticsCUs({Key? key}) : super(key: key);
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        usDataPolitics
                                            .propertyUsPolitics[3].description,
