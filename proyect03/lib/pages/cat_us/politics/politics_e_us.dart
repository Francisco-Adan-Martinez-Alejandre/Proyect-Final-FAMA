...
class PoliticsEUs extends StatelessWidget {
  const PoliticsEUs({Key? key}) : super(key: key);
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        usDataPolitics
                                            .propertyUsPolitics[5].description,
