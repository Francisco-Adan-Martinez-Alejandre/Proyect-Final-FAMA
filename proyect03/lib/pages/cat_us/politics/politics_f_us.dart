...
class PoliticsFUs extends StatelessWidget {
  const PoliticsFUs({Key? key}) : super(key: key);
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        usDataPolitics
                                            .propertyUsPolitics[6].description,
