...
class PoliticsDUs extends StatelessWidget {
  const PoliticsDUs({Key? key}) : super(key: key);
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        usDataPolitics
                                            .propertyUsPolitics[4].description,
