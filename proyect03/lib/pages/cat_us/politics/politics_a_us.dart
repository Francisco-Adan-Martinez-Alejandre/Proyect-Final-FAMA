...
class PoliticsAUs extends StatelessWidget {
  const PoliticsAUs({Key? key}) : super(key: key);
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        usDataPolitics
                                            .propertyUsPolitics[1].description,
