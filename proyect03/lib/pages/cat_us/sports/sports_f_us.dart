...
class SportsFUs extends StatelessWidget {
  const SportsFUs({Key? key}) : super(key: key);
                              ...
                              child: ListView(
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        usDataSports.propertyUsSports[6].title,
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        usDataSports
                                            .propertyUsSports[6].description,
