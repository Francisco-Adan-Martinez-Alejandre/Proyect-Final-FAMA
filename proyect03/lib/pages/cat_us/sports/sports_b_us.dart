...
class SportsBUs extends StatelessWidget {
  const SportsBUs({Key? key}) : super(key: key);
                              ...
                              child: ListView(
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        usDataSports.propertyUsSports[2].title,
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        usDataSports
                                            .propertyUsSports[2].description,
