...
class SportsDUs extends StatelessWidget {
  const SportsDUs({Key? key}) : super(key: key);
                              ...
                              child: ListView(
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        usDataSports.propertyUsSports[4].title,
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        usDataSports
                                            .propertyUsSports[4].description,
