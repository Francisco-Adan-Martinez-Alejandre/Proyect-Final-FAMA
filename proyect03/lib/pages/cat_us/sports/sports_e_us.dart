...
class SportsEUs extends StatelessWidget {
  const SportsEUs({Key? key}) : super(key: key);
                              ...
                              child: ListView(
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        usDataSports.propertyUsSports[5].title,
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        usDataSports
                                            .propertyUsSports[5].description,
