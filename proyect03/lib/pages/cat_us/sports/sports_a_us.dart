...
class SportsAUs extends StatelessWidget {
  const SportsAUs({Key? key}) : super(key: key);
                              ...
                              child: ListView(
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        usDataSports.propertyUsSports[1].title,
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        usDataSports
                                            .propertyUsSports[1].description,
