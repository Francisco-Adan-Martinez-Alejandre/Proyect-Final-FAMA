...
import 'package:proyect02/pages/cat_us/sports/sports_d_us.dart';
import 'package:proyect02/pages/cat_us/sports/sports_e_us.dart';
import 'package:proyect02/pages/cat_us/sports/sports_f_us.dart';
import 'package:proyect02/pages/home_page.dart';
import 'package:proyect02/services/us_services_sports.dart';

class UsSports extends StatelessWidget {
  const UsSports({Key? key}) : super(key: key);
                  ...
                  Column(
                    children: [
                      ...
                      InkWell(
                        onTap: () {
                          Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => const SportsDUs(),
                          ));
                        },
                        child: Container(
                          height: 150,
                      ...
                      InkWell(
                        onTap: () {
                          Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => const SportsEUs(),
                          ));
                        },
                        child: Container(
                          height: 150,
                      ...
                      InkWell(
                        onTap: () {
                          Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => const SportsFUs(),
                          ));
                        },
                        child: Container(
                          height: 150,
