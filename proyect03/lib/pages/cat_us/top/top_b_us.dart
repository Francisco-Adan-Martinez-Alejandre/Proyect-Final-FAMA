...
class TopBUs extends StatelessWidget {
  const TopBUs({Key? key}) : super(key: key);
                                ...
                                Column(
                                  children: [
                                    SizedBox(
                                      ...
                                      child: Text(
                                        "Author: " +
                                            usDataTop.propertyUsTop[2].creator,
                              ...
                              child: ListView(
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        usDataTop.propertyUsTop[2].description,
                              ...
                              child: ListView(
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        usDataTop.propertyUsTop[2].content,
                                        textAlign: TextAlign.justify,
                                        style: const TextStyle(
                                            color: Color.fromARGB(235, 0, 0, 0),
                                            fontSize: 15,
