...
import 'package:proyect02/pages/cat_us/top/top_d_us.dart';
import 'package:proyect02/pages/cat_us/top/top_e_us.dart';
import 'package:proyect02/pages/cat_us/top/top_f_us.dart';
import 'package:proyect02/pages/home_page.dart';
import 'package:proyect02/services/us_services_top.dart';

class UsTop extends StatelessWidget {
  const UsTop({Key? key}) : super(key: key);
                                  ...
                                  Column(
                                    children: [
                                      SizedBox(
                                        ...
                                        width: 140,
                                        child: Text(
                                          usDataTop.propertyUsTop[1].title,
                                      ...
                                      SizedBox(
                                        ...
                                        width: 140,
                                        child: Text(
                                          usDataTop.propertyUsTop[1].pubDate,
                                          textAlign: TextAlign.center,
                                          style: const TextStyle(
                                              color:
                                                  Color.fromARGB(235, 0, 0, 0),
                                  ...
                                  Column(
                                    children: [
                                      SizedBox(
                                        ...
                                        width: 140,
                                        child: Text(
                                          usDataTop.propertyUsTop[2].title,
                                          textAlign: TextAlign.center,
                                          style: const TextStyle(
                                              color:
                                                  Color.fromARGB(235, 0, 0, 0),
                                      ...
                                      SizedBox(
                                        ...
                                        width: 140,
                                        child: Text(
                                          usDataTop.propertyUsTop[2].pubDate,
                                          textAlign: TextAlign.center,
                                          style: const TextStyle(
                                              color:
                                                  Color.fromARGB(235, 0, 0, 0),
                                  ...
                                  Column(
                                    children: [
                                      SizedBox(
                                        ...
                                        width: 140,
                                        child: Text(
                                          usDataTop.propertyUsTop[3].title,
                                          textAlign: TextAlign.center,
                                          style: const TextStyle(
                                              color:
                                                  Color.fromARGB(235, 0, 0, 0),
                                      ...
                                      SizedBox(
                                        ...
                                        width: 140,
                                        child: Text(
                                          usDataTop.propertyUsTop[3].pubDate,
                                          textAlign: TextAlign.center,
                                          style: const TextStyle(
                                              color:
                                                  Color.fromARGB(235, 0, 0, 0),
                                  ...
                                  Column(
                                    children: [
                                      SizedBox(
                                        ...
                                        width: 140,
                                        child: Text(
                                          usDataTop.propertyUsTop[4].title,
                                          textAlign: TextAlign.center,
                                          style: const TextStyle(
                                              color:
                                                  Color.fromARGB(235, 0, 0, 0),
                                      ...
                                      SizedBox(
                                        ...
                                        width: 140,
                                        child: Text(
                                          usDataTop.propertyUsTop[4].pubDate,
                                          textAlign: TextAlign.center,
                                          style: const TextStyle(
                                              color:
                                                  Color.fromARGB(235, 0, 0, 0),
                                  ...
                                  Column(
                                    children: [
                                      SizedBox(
                                        ...
                                        width: 140,
                                        child: Text(
                                          usDataTop.propertyUsTop[5].title,
                                          textAlign: TextAlign.center,
                                          style: const TextStyle(
                                              color:
                                                  Color.fromARGB(235, 0, 0, 0),
                                      ...
                                      SizedBox(
                                        ...
                                        width: 140,
                                        child: Text(
                                          usDataTop.propertyUsTop[5].pubDate,
                                          textAlign: TextAlign.center,
                                          style: const TextStyle(
                                              color:
                                                  Color.fromARGB(235, 0, 0, 0),
                                  ...
                                  Column(
                                    children: [
                                      SizedBox(
                                        ...
                                        width: 140,
                                        child: Text(
                                          usDataTop.propertyUsTop[6].title,
                                          textAlign: TextAlign.center,
                                          style: const TextStyle(
                                              color:
                                                  Color.fromARGB(235, 0, 0, 0),
                                      ...
                                      SizedBox(
                                        ...
                                        width: 140,
                                        child: Text(
                                          usDataTop.propertyUsTop[6].pubDate,
                                          textAlign: TextAlign.center,
                                          style: const TextStyle(
                                              color:
                                                  Color.fromARGB(235, 0, 0, 0),
