...
class EnterBCo extends StatelessWidget {
  const EnterBCo({Key? key}) : super(key: key);
                              ...
                              child: ListView(
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        coDataEnter.propertyCoEnter[2].title,
                              ...
                              child: ListView(
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        coDataEnter.propertyCoEnter[2].content,
                                        textAlign: TextAlign.justify,
                                        style: const TextStyle(
                                            color: Color.fromARGB(235, 0, 0, 0),
                                            fontSize: 15,
