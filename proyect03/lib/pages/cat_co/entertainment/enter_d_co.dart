...
class EnterDCo extends StatelessWidget {
  const EnterDCo({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    final coDataEnter = Provider.of<CoServicesEnter>(context);

    if (coDataEnter.propertyCoEnter.isEmpty) {
      return Container(
                              ...
                              child: ListView(
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        coDataEnter.propertyCoEnter[4].title,
                                  ...
                                  children: [
                                    SizedBox(
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: Image.network(
                                          leerImagen(coDataEnter
                                              .propertyCoEnter[4].imageUrl),
                                        ),
                                      ),
                                    ),
                                  ],
                              ...
                              child: ListView(
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        coDataEnter.propertyCoEnter[4].content,
                                        textAlign: TextAlign.justify,
                                        style: const TextStyle(
                                            color: Color.fromARGB(235, 0, 0, 0),
                                            fontSize: 15,
