...
import 'package:proyect02/pages/cat_co/sports/sports_d_co.dart';
import 'package:proyect02/pages/cat_co/sports/sports_e_co.dart';
import 'package:proyect02/pages/cat_co/sports/sports_f_co.dart';
import 'package:proyect02/pages/home_page.dart';
import 'package:proyect02/services/co_services_sports.dart';

class CoSports extends StatelessWidget {
  const CoSports({Key? key}) : super(key: key);
                  ...
                  Column(
                    children: [
                      ...
                      InkWell(
                        onTap: () {
                          Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => const SportsDCo(),
                          ));
                        },
                        child: Container(
                          height: 150,
                      ...
                      InkWell(
                        onTap: () {
                          Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => const SportsECo(),
                          ));
                        },
                        child: Container(
                          height: 150,
                      ...
                      InkWell(
                        onTap: () {
                          Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => const SportsFCo(),
                          ));
                        },
                        child: Container(
                          height: 150,
