...
class SportsBCo extends StatelessWidget {
  const SportsBCo({Key? key}) : super(key: key);
                              ...
                              child: ListView(
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        coDataSports.propertyCoSports[2].title,
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        coDataSports
                                            .propertyCoSports[2].description,
