...
class SportsDCo extends StatelessWidget {
  const SportsDCo({Key? key}) : super(key: key);
                              ...
                              child: ListView(
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        coDataSports.propertyCoSports[4].title,
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        coDataSports
                                            .propertyCoSports[4].description,
