...
class SportsCCo extends StatelessWidget {
  const SportsCCo({Key? key}) : super(key: key);
                              ...
                              child: ListView(
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        coDataSports.propertyCoSports[3].title,
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        coDataSports
                                            .propertyCoSports[3].description,
