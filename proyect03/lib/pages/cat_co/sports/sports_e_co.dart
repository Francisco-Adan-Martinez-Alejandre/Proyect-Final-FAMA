...
class SportsECo extends StatelessWidget {
  const SportsECo({Key? key}) : super(key: key);
                              ...
                              child: ListView(
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        coDataSports.propertyCoSports[5].title,
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        coDataSports
                                            .propertyCoSports[5].description,
