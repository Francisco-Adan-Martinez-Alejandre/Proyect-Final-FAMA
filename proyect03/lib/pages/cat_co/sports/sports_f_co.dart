...
class SportsFCo extends StatelessWidget {
  const SportsFCo({Key? key}) : super(key: key);
                              ...
                              child: ListView(
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        coDataSports.propertyCoSports[6].title,
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        coDataSports
                                            .propertyCoSports[6].description,
