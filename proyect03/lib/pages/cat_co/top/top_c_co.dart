...
class TopCCo extends StatelessWidget {
  const TopCCo({Key? key}) : super(key: key);
                                ...
                                Column(
                                  children: [
                                    SizedBox(
                                      ...
                                      child: Text(
                                        "Autor: " +
                                            coDataTop.propertyCoTop[3].creator,
                              ...
                              child: ListView(
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        coDataTop.propertyCoTop[3].description,
                              ...
                              child: ListView(
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        coDataTop.propertyCoTop[3].content,
                                        textAlign: TextAlign.justify,
                                        style: const TextStyle(
                                            color: Color.fromARGB(235, 0, 0, 0),
                                            fontSize: 15,
