...
class PoliticsDCo extends StatelessWidget {
  const PoliticsDCo({Key? key}) : super(key: key);
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        coDataPolitics
                                            .propertyCoPolitics[4].description,
