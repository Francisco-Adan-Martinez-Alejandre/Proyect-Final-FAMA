...
class PoliticsECo extends StatelessWidget {
  const PoliticsECo({Key? key}) : super(key: key);
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        coDataPolitics
                                            .propertyCoPolitics[5].description,
