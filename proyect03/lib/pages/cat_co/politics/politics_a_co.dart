...
class PoliticsACo extends StatelessWidget {
  const PoliticsACo({Key? key}) : super(key: key);
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        coDataPolitics
                                            .propertyCoPolitics[0].description,
