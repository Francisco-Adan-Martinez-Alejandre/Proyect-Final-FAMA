...
class PoliticsFCo extends StatelessWidget {
  const PoliticsFCo({Key? key}) : super(key: key);
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        coDataPolitics
                                            .propertyCoPolitics[6].description,
