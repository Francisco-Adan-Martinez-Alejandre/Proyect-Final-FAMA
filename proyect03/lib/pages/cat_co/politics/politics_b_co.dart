...
class PoliticsBCo extends StatelessWidget {
  const PoliticsBCo({Key? key}) : super(key: key);
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        coDataPolitics
                                            .propertyCoPolitics[1].description,
