...
class PoliticsCCo extends StatelessWidget {
  const PoliticsCCo({Key? key}) : super(key: key);
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        coDataPolitics
                                            .propertyCoPolitics[2].description,
