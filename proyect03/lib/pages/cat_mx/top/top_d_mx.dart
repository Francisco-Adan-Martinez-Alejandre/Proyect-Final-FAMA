...
class TopDMx extends StatelessWidget {
  const TopDMx({Key? key}) : super(key: key);
                                ...
                                Column(
                                  children: [
                                    SizedBox(
                                      ...
                                      child: Text(
                                        "Autor: " +
                                            mxDataTop.propertyMxTop[4].creator,
                              ...
                              child: ListView(
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        mxDataTop.propertyMxTop[4].description,
                              ...
                              child: ListView(
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        mxDataTop.propertyMxTop[4].content,
                                        textAlign: TextAlign.justify,
                                        style: const TextStyle(
                                            color: Color.fromARGB(235, 0, 0, 0),
                                            fontSize: 15,
