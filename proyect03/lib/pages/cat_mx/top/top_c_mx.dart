...
class TopCMx extends StatelessWidget {
  const TopCMx({Key? key}) : super(key: key);
                                ...
                                Column(
                                  children: [
                                    SizedBox(
                                      ...
                                      child: Text(
                                        "Autor: " +
                                            mxDataTop.propertyMxTop[3].creator,
                              ...
                              child: ListView(
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        mxDataTop.propertyMxTop[3].description,
                              ...
                              child: ListView(
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        mxDataTop.propertyMxTop[3].content,
                                        textAlign: TextAlign.justify,
                                        style: const TextStyle(
                                            color: Color.fromARGB(235, 0, 0, 0),
                                            fontSize: 15,
