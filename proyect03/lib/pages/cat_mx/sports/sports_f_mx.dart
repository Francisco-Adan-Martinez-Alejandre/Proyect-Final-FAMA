...
class SportsFMx extends StatelessWidget {
  const SportsFMx({Key? key}) : super(key: key);
                              ...
                              child: ListView(
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        mxDataSports.propertyMxSports[6].title,
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        mxDataSports
                                            .propertyMxSports[6].description,
