...
class SportsDMx extends StatelessWidget {
  const SportsDMx({Key? key}) : super(key: key);
                              ...
                              child: ListView(
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        mxDataSports.propertyMxSports[4].title,
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        mxDataSports
                                            .propertyMxSports[4].description,
