...
class SportsAMx extends StatelessWidget {
  const SportsAMx({Key? key}) : super(key: key);
                              ...
                              child: ListView(
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        mxDataSports.propertyMxSports[1].title,
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        mxDataSports
                                            .propertyMxSports[1].description,
