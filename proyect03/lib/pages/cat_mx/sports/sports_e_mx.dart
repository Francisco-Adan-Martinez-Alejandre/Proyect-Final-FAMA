...
class SportsEMx extends StatelessWidget {
  const SportsEMx({Key? key}) : super(key: key);
                              ...
                              child: ListView(
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        mxDataSports.propertyMxSports[5].title,
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        mxDataSports
                                            .propertyMxSports[5].description,
