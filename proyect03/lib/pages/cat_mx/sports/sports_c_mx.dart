...
class SportsCMx extends StatelessWidget {
  const SportsCMx({Key? key}) : super(key: key);
                              ...
                              child: ListView(
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        mxDataSports.propertyMxSports[3].title,
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        mxDataSports
                                            .propertyMxSports[3].description,
