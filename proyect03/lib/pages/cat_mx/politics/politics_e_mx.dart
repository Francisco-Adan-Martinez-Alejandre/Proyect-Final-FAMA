...
class PoliticsEMx extends StatelessWidget {
  const PoliticsEMx({Key? key}) : super(key: key);
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        mxDataPolitics
                                            .propertyMxPolitics[5].description,
