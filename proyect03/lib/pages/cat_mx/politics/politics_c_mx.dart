...
class PoliticsCMx extends StatelessWidget {
  const PoliticsCMx({Key? key}) : super(key: key);
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        mxDataPolitics
                                            .propertyMxPolitics[3].description,
