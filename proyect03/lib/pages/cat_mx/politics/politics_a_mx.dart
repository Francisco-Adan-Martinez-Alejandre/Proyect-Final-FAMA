...
class PoliticsAMx extends StatelessWidget {
  const PoliticsAMx({Key? key}) : super(key: key);
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        mxDataPolitics
                                            .propertyMxPolitics[1].description,
