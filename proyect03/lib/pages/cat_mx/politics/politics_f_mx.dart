...
class PoliticsFMx extends StatelessWidget {
  const PoliticsFMx({Key? key}) : super(key: key);
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        mxDataPolitics
                                            .propertyMxPolitics[6].description,
