...
class PoliticsDMx extends StatelessWidget {
  const PoliticsDMx({Key? key}) : super(key: key);
                                ...
                                children: [
                                  Column(
                                    children: [
                                      Text(
                                        mxDataPolitics
                                            .propertyMxPolitics[4].description,
